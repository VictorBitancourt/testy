...
class SmokeTest < ApplicationSystemTestCase
  ...
  test "user can create a new bug" do
    login_as(@user)

    visit new_bug_path
    fill_in "Title", with: "Smoke test"
    fill_in "Description", with: "Just testing..."
    fill_in "Feature", with: "checkout"
    fill_in "Root Cause", with: "database"
    click_button "Report Bug"

    assert_text "Bug reported successfully!"
  end

  test "User can access The Root of All Evil page" do
    login_as(@user)

    visit bugs_path
    click_on "The Root Of All Evil"

    assert_text "bugs analyzed"
  end
